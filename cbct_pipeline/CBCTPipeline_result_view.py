...
if __name__ == "__main__":
    print(read_pickled_config(path='data/20250922_InnoCare_TIFF/results_astra/config_snapshot.pickle'))
    view_pickled_volume_napari(path='data/20250922_InnoCare_TIFF/results_astra/volume.pickle')